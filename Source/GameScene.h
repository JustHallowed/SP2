...
public:
	~GameScene() override {}
	void Init() override, Update(double, float, const unsigned char*) override, Render(double, int, int) override, RenderScreen1(double, int, int), RenderScreen2(double, int, int), Exit(Scene*) override;
};